...
public class TestTupleDomain
{
            ...
            throws Exception
    {
        ...
        // But since we know that ConnectorColumnHandle will always be a TestingColumnHandle in this test,
        // let's just always deserialize ConnectorColumnHandle as a TestingColumnHandle.

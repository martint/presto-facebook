        ...
        implements SplitSource
{
    ...
    private final double sampleRation;

    public SampledSplitSource(SplitSource splitSource, double sampleRation)
    {
        this.splitSource = checkNotNull(splitSource, "dataSource is null");
        this.sampleRation = sampleRation;
    }
            ...
            throws InterruptedException
    {
        ...
        Iterable<Split> sampleIterable = Iterables.filter(nextBatch, new Predicate<Split>()
        {
            ...
            {
                return ThreadLocalRandom.current().nextDouble() < sampleRation;
            }
        });

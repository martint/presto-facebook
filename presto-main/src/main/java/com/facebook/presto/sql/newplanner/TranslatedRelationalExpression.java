...
public class TranslatedRelationalExpression
{
    private final TupleDescriptor fields;
    private final RelationalExpression expression;
    private final List<ResolvedName> boundVariables;

    public TranslatedRelationalExpression(TupleDescriptor fields, RelationalExpression expression, List<ResolvedName> boundVariables)
    {
        this.fields = fields;
    ...
    public TupleDescriptor getFields()
    {
        return fields;
    }

...
public class ImplementUnpartitionedHashJoin
        implements ImplementationRule
{
    ...
    public List<RelExpr> optimize(RelExpr expression, PhysicalConstraints requirements, OptimizerCallback optimizer)
    {
        ...
        RelExpr optimizedLeft = optimizer.optimize(left, PhysicalConstraints.unpartitioned());
        RelExpr optimizedRight = optimizer.optimize(right, PhysicalConstraints.unpartitioned());
